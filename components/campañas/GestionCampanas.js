...
function GestionCampanas(props) {
                        ...
                        <div className="row">
                            <div className="col-md-6 mt-4">
                                <div className="card bg-light mb-3">
                                    ...
                                    <div className="card-body">
                                        ...
                                        <Link href={{ pathname: "gestioncaso/[campana]", query: { camp: 'Atrasado', empresa: 'werchow', operador: operadorNom } }}
                                        >
                                            <a
                            ...
                            <div className="col-md-6 mt-4">
                                <div className="card bg-light mb-3">
                                    ...
                                    <div className="card-body">
                                        <h5 className="card-title">Listado de casos</h5>
                                        <Link href={{ pathname: "gestioncaso/[campana]", query: { camp: 'Recuperacion', empresa: 'werchow', operador: operadorNom } }}
                                        >
                                            <a
                                                className="btn btn-primary"
                                            >
                            ...
                            <div className="col-md-6 mt-4">
                                <div className="card bg-light mb-3">
                                    ...
                                    <div className="card-body">
                                        <h5 className="card-title">Listado de casos</h5>
                                        <Link href={{ pathname: "gestioncaso/[campana]", query: { camp: 'Reincidente', empresa: 'werchow', operador: operadorNom } }}
                                        >
                                            <a
                                                className="btn btn-primary"
                                            >
                            ...
                            <div className="col-md-6 mt-4">
                                <div className="card bg-light mb-3">
                                    ...
                                    <div className="card-body">
                                        <h5 className="card-title">Listado de casos:</h5>
                                        <Link href={{ pathname: "gestioncaso/[campana]", query: { camp: 'Blanqueo', empresa: 'werchow', operador: operadorNom } }}
                                        >
                                            <a
                                                className="btn btn-primary"
                                            >
                            ...
                            <div className="col-md-6 mt-4">
                                <div className="card bg-light mb-3">
                                    ...
                                    <div className="card-body">
                                        ...
                                        <Link href={{ pathname: "gestioncaso/[campana]", query: { camp: 'Recordatorio', empresa: 'werchow', operador: operadorNom } }}
                                        >
                                            <a
                                                className="btn btn-primary"
                                            >
