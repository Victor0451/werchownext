...
const FormLiquidarServicio = ({
  ...
  return (
    <div>
      <div className="container border border-dark list p-4">
        {servicio ? (
          <>
            <h2>
              <strong>
                <u>Servicio N° {servicio.idservicio} - Extinto</u>:{" "}
                  ...
                  <div className=" col-md-4">
                    <label>
                      ...
                      <input
                        ...
                        value={moment(servicio.fecha_recepcion).format(
                          "DD/MM/YYYY HH:mm:ss"
                        )}
                      />
                    </label>
                  ...
                  <div className="mt-4 col-md-4">
                    <label>
                      ...
                      <input
                        type="text"
                        className="mt-2 form-control"
                        value={servicio.lugar_fallecimiento}
                      />
                    </label>
                  </div>
                  ...
                  <div className="mt-4 col-md-4">
                    <label>
                      ...
                      <input
                        type="text"
                        className="mt-2 form-control"
                        value={servicio.casa_mortuaria}
                      />
                    </label>
                  </div>
                  <div className="mt-4 col-md-4">
                    <label>
                      <u>Fecha de inhumacion</u>
                      <input
                        type="text"
                        className="mt-2 form-control"
                        value={moment(servicio.fecha_inhumacion).format(
                          "DD/MM/YYYY"
                        )}
                      />
                    </label>
      ...
      <div className=" mb-4 card bg-info">
        ...
        <ul className="list-group list-group-flush">
          <li className="list-group-item text-uppercase">
            {servmes ? (
              <>Cantidad de servicios en el mes de : {servmes.cant}</>
            ) : (
          ...
          <li className="list-group-item text-uppercase ">
            {aculiqop ? (
              <>
                Acumulado de Liquidaciones del mes: {aculiqop.cant}, por un
                monto de: $ {aculiqop.monto}
              </>
            ) : (
              <>No hay registros aun.</>
            )}
          ...
          <li className="list-group-item text-uppercase">
            {acugascaja ? (
              <>
                Acumulado de gastos por caja de sepelio del mes: ${" "}
                {acugascaja.total}
              </>
            ) : (
              <>No hay registros aun.</>
      ...
      {liqop ? (
        <div className=" border border-dark  mt-4 p-4">
                            ...
                            <>
                              {row.original.liquidado == 0 ? (
                                ...
                                <div>
                                  ...
                                  {moment(
                                    row.original.fecha_liquidacion
          ...
          <div className="row">
            ...
            <div className="col-md-6">
              <div className="mt-4 alert alert-info text-center text-uppercase border border-dark ">
                Acumulado de Liquidacion del personal en el mes: ${" "}
                {aculiqop.monto}
              </div>
            </div>
          </div>
          ...
          <div className="row">
            <div className="col-md-6">
              <div className="mt-4 border border-dark alert alert-info text-center text-uppercase">
                Total Gastos Por Caja de Sepelio: $ {calcularTotal(cajas)}
              </div>
            </div>
            <div className="col-md-6">
              <div className="mt-4 alert alert-info text-center text-uppercase border border-dark ">
                Acumulado por caja de sepelio en el mes: $ {acugascaja.total}
              </div>
            </div>
          </div>
        </div>
      ...
      {cajas ? (
        <div className="mt-4 border border-dark alert alert-info text-center text-uppercase">
          Total Gastos En este Servicio: ${" "}
          {parseInt(calcularTotal(cajas)) + parseInt(total(liqop))}
        </div>
      ) : null}
    </div>
  );
