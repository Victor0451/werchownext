      ...
      <div className="mt-4 border border-dark p-4">
        <div className="row">
          ...
          <div className="mt-4 form-group col-md-3">
            ...
            <select className="custom-select" name="empresa" ref={empresaRef}>
          ...
          <div className="mt-4 form-group col-md-3">
            ...
            <select className="custom-select" name="operador" ref={sucursalRef}>
              <option selected value="no">
                {" "}
                Elige una Opcion{" "}
              </option>
          ...
          <div className="mt-4 form-group col-md-4">
            ...
            <select className="custom-select" ref={tipoMovRef}>
              <option selected value="no">
                {" "}
                Elige una Opcion{" "}
              </option>
