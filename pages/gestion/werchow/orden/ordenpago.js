...
const OrdenPago = () => {
  ...
  const traerTipoFac = async () => {
    await axios
      .get(`${ip}api/sgi/ordenpago/tipofacturas`)
      .then((res) => {
      ...
      .catch((error) => {
        console.log(error);
        toastr.error(
          "Ocurrio un error al traer los tipos de facturas",
          "ATENCION"
        );
      });
  };
  ...
  const nOrden = async () => {
    await axios
      .get(`${ip}api/sgi/ordenpago/norden`)
      .then((res) => {
        if (!res.data.idorden) {
  ...
  const buscarOrdenes = async (f) => {
    if (f === "orden") {
      if (medicoRef.current.value === "no") {
        ...
        await axios
          .get(`${ip}api/sgi/ordenpago/ordenesprestador/${codigo}`)
          .then((res) => {
            ...
            axios
              .get(`${ip}api/sgi/ordenpago/ordenesprestadorfa/${codigo}`)
              .then((res1) => {
                let resto = res1.data;
              ...
              .catch((error) => {
                console.log(error);
                toastr.error(
                  "Ocurrio un error al generar las ordenes",
                  "ATENCION"
                );
              });
          })
      ...
      if (medicoPracRef.current.value === "no") {
        ...
        await axios
          .get(`${ip}api/sgi/ordenpago/practicasprestador/${codigo}`)
          .then((res) => {
            toastr.success("Listado de ordenes generadas", "ATENCION");
            ...
            axios
              .get(`${ip}api/sgi/ordenpago/practicasprestadorfa/${codigo}`)
              .then((res1) => {
                let resto = res1.data;
  ...
  const postOrdenMedicas = async (orPag) => {
    await axios
      .post(`${ip}api/sgi/ordenpago/nuevaorden`, orPag)
      .then((res) => {
        if (res.status === 200) {
          toastr.info(
      ...
      .catch((error) => {
        console.log(error);
        toastr.error(
          "Ocurrio un error al generar la orden de pago",
          "ATENCION"
        );
      });
  };
  ...
  const updateCheckUsos = async (orden, nor, fec) => {
    ...
    await axios
      .put(`${ip}api/sgi/ordenpago/updatecheckusos/${orden}`, valores)
      .then((res) => {
        console.log(res);
      })
      .catch((error) => {
    ...
    await axios
      .put(`${ip}api/sgi/ordenpago/updatecheckusosfa/${orden}`, valores)
      .then((res) => {
        console.log(res);
      })
      .catch((error) => {
  ...
  const buscarOrden = async (f) => {
    ...
    if (f === "O") {
      ...
      if (ord === "") {
        ...
        await axios
          .get(`${ip}api/sgi/servicios/buscarordenotero/${ord}`)
          .then((res) => {
            if (res.data.length > 0) {
              guardarOrden(res.data);
            } else if (res.data.length === 0) {
              toastr.info(
                "La orden que estas buscando no se encuentra registrada",
                "ATENCION"
              );
            }
          })
      ...
      if (ord === "") {
        ...
        await axios
          .get(`${ip}api/sgi/servicios/buscarordenfabian/${ord}`)
          .then((res) => {
            if (res.data.length > 0) {
              guardarOrden(res.data);
            } else if (res.data.length === 0) {
      ...
      buttons: [
        {
          ...
          onClick: () => {
            if (f === "O") {
              axios
                .put(`${ip}api/sgi/servicios/aprobarordenotero/${orden}`)
                .then((res) => {
                  if (res.status === 200) {
                ...
                .catch((error) => {
                  console.log(error);
                  toastr.error(
                    "Ocurrio un error al levantar la orden",
                    "ATENCION"
                  );
                });
            } else if (f !== "O") {
              axios
                .put(`${ip}api/sgi/servicios/aprobarordenfabian/${orden}`)
                .then((res) => {
                  if (res.status === 200) {
                    toastr.success("Orden levantada", "ATENCION");
      ...
      buttons: [
        {
          ...
          onClick: () => {
            ...
            if (f === "O") {
              axios
                .put(`${ip}api/sgi/servicios/cambiarimporteordenotero`, datos)
                .then((res) => {
                  if (res.status === 200) {
              ...
              axios
                .put(`${ip}api/sgi/servicios/cambiarimporteordenfabian`, datos)
                .then((res) => {
