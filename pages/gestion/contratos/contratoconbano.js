        ...
        <Layout >
            ...
            <div className="list mb-4">
                ...
                >
                    ...
                    <p className="text-justify">
                        <u>SEGUNDA:</u> el termino de la Locacion será de tres (3) años a
                        partir de la fecha citada, feneciendo el{" "}
                        <strong>{moment(contrato.fecha_inicio).add(3, "y").format('DD/MM/YYYY')}</strong>,. A su
...
export default ContratoConBaño