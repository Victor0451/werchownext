...
var Gantt = function(_Widget) {
    ...
    _proto._updateTreeListDataSource = function() {
        var forceUpdate = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : false;
            ...
            var updateCallback = function(key, data) {
                ...
                if (dataOption && data) {
                    dataOption.update(key, data, function(data, key) {
                        ...
                        _this12._updateTreeListDataSource(isCustomFieldsUpdateOnly);
                        dataOption._reloadDataSource();
    ...
    _proto.updateTask = function(key, data) {
        var coreTaskData = this._convertMappedToCoreData(GANTT_TASKS, data);
