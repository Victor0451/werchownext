...
var TagBox = _select_box.default.inherit({
    ...
    _getScrollRtlBehavior: function() {
        return _browser.default.msie && _browser.default.version < 12 ? {
            decreasing: false,
            positive: true
        } : {
            decreasing: true,
    ...
    _getBorderPosition: function(direction) {
        ...
        var scrollBehavior = this._getScrollRtlBehavior();
        var scrollSign = !rtlEnabled || scrollBehavior.positive ? 1 : -1;
        return isScrollLeft ^ !rtlEnabled ? 0 : scrollSign * (this._$tagsContainer.get(0).scrollWidth - this._$tagsContainer.outerWidth())
    },
        ...
        var selectedItems = plainItems.filter(function(dataItem) {
            ...
            for (var i = 0; i < values.length; i++) {
                ...
                if ((0, _type.isObject)(currentValue)) {
                    ...
                    if (_this11._isValueEquals(_this11._valueGetter(dataItem), currentValue)) {
                        return true
                    }
                }
            }
