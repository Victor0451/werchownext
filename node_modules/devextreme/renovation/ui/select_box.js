...
exports.viewFunction = exports.SelectBoxProps = void 0;
...
function SelectBox(props) {
    ...
    var __restAttributes = (0, _hooks.useCallback)(function() {
        ...
        var _props$value$rootElem = _objectSpread(_objectSpread({}, props), {}, {
            ...
            restProps = (_props$value$rootElem._feedbackHideTimeout, _props$value$rootElem._feedbackShowTimeout, _props$value$rootElem.accessKey, _props$value$rootElem.activeStateEnabled, _props$value$rootElem.activeStateUnit, _props$value$rootElem.aria, _props$value$rootElem.children, _props$value$rootElem.className, _props$value$rootElem.classes, _props$value$rootElem.dataSource, _props$value$rootElem.defaultValue, _props$value$rootElem.disabled, _props$value$rootElem.displayExpr, _props$value$rootElem.focusStateEnabled, _props$value$rootElem.height, _props$value$rootElem.hint, _props$value$rootElem.hoverStateEnabled, _props$value$rootElem.name, _props$value$rootElem.onActive, _props$value$rootElem.onClick, _props$value$rootElem.onContentReady, _props$value$rootElem.onDimensionChanged, _props$value$rootElem.onFocusIn, _props$value$rootElem.onFocusOut, _props$value$rootElem.onInactive, _props$value$rootElem.onKeyDown, _props$value$rootElem.onKeyboardHandled, _props$value$rootElem.onVisibilityChange, _props$value$rootElem.rootElementRef, _props$value$rootElem.rtlEnabled, _props$value$rootElem.tabIndex, _props$value$rootElem.value, _props$value$rootElem.valueChange, _props$value$rootElem.valueExpr, _props$value$rootElem.visible, _props$value$rootElem.width, _objectWithoutProperties(_props$value$rootElem, _excluded2));
        return restProps
    }, [props, __state_value]);
    return viewFunction({
