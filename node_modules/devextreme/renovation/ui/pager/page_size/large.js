...
exports.viewFunction = exports.PageSizeLargeProps = void 0;
...
function PageSizeLarge(props) {
    ...
    var __pageSizesText = (0, _hooks.useCallback)(function() {
        var pageSizes = props.pageSizes;
        return pageSizes.map(function(_ref3) {
            var text = _ref3.text,
                processedPageSize = _ref3.value;
            var selected = processedPageSize === (void 0 !== props.pageSize ? props.pageSize : __state_pageSize);
    ...
    var __onPageSizeChange = (0, _hooks.useCallback)(function(processedPageSize) {
        return function() {
            var _props$pageSizeChange;
            __state_setPageSize(function(__state_pageSize) {
                return processedPageSize
            }), null === (_props$pageSizeChange = props.pageSizeChange) || void 0 === _props$pageSizeChange ? void 0 : _props$pageSizeChange.call(props, processedPageSize)
        }
    ...
    var __restAttributes = (0, _hooks.useCallback)(function() {
        var _props$pageSize = _objectSpread(_objectSpread({}, props), {}, {
            ...
            restProps = (_props$pageSize.defaultPageSize, _props$pageSize.pageSize, _props$pageSize.pageSizeChange, _props$pageSize.pageSizes, _objectWithoutProperties(_props$pageSize, _excluded));
        return restProps
